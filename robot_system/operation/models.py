...
class User(models.Model):
	...
	user_tel = models.CharField(max_length=10, default='')
	user_career = models.CharField(max_length=15, default='')
	user_age = models.IntegerField(default=0)
	user_income = models.IntegerField(default=1000)
...
class Information(models.Model):
	...
	weights = ArrayField(models.CharField(max_length=50))
	shares = ArrayField(models.CharField(max_length=50))

class Member_invest(models.Model):
	user = models.ForeignKey(User, on_delete=models.CASCADE)
	combinations = models.ForeignKey(Information, on_delete=models.CASCADE)
	date = models.DateTimeField()
	total = models.ImageField(default=0)
